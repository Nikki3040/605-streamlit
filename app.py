...
st.subheader("1B. What are the long-term trends in bike usage over the years?")
...
st.subheader("1C. How does bike demand fluctuate throughout the day?")
...
st.subheader("1D. Are there noticeable weekly trends in bike usage?")
...
st.subheader("1F. How does bike rental demand fluctuate across different months of the year? Are there noticeable seasonal patterns in hourly usage?")
